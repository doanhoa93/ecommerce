  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form:form id="update-category" action="${contextPath}/admin/categories/${category.getId()}"
          method="PATCH" enctype="multipart/form-data" modelAttribute="category"
          class="category-form">
          ...
          <div class="field">
            ...
            <input list="parentCategories" value="${category.getParentName()}"
              placeholder="Name of Parent" id="parent-input" class="form-control" />
